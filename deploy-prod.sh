...
echo "   - Nginx Proxy: http://localhost:8080 (main app)"
echo "   - Database: PostgreSQL on port 5432"
echo "   - ChromaDB: http://localhost:3052"
echo ""
echo "🌐 For your domain to work, you need to:"
echo "   1. Configure your reverse proxy (port 80) to forward to localhost:8080"
echo "   2. OR access directly at: http://hypercare.zyroi.com:8080"
echo ""
echo "📝 To check logs:"
